...
using System.Text;
using AVA.ForBrain.ApplicationCore.Helpers;
...
namespace AVA.ForBrain.ApplicationCore.Services.Common
{
    public class UserService : IUserService
    {
        ...
        private List<User> _users = new List<User>
        {
            ...
            new User { Id = 2, FirstName = "Normal", LastName = "User", Username = "user", Password = "user", Role = Role.Aluno }
        };

        private readonly AppSettingsSecret _appSettings;

        public UserService(IOptions<AppSettingsSecret> appSettings)
        {
